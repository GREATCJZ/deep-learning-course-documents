...
from PIL.ImageFilter import EMBOSS, CONTOUR, BLUR, GaussianBlur
...
# def add_noise(img):
#     for i in range(random.randint(50,250)):  # 添加点噪声
#         temp_x = random.randint(0, img.size[0])
#         temp_y = random.randint(0, img.size[1])
